            ...
            <>
              <div className="footer-column company-info">
                ...
                <p className="footer-description">
                  The premier platform for discovering and hosting events. We connect passionate
                  organizers with enthusiastic attendees to create unforgettable experiences.
                </p>
              ...
              <div className="footer-column">
                ...
                <ul className="footer-links">
                  ...
                  <li>
                    <Link to="/events?filter=upcoming">Upcoming Events</Link>
                  </li>
                  <li>
                    <Link to="/events?filter=popular">Popular Events</Link>
                  </li>
                </ul>
              </div>
              ...
              <div className="footer-column">
                ...
                <ul className="footer-links">
                  <li>
                    <button className="footer-link-btn" type="button" onClick={() => openSupport('')}>
                      Help Center
                    </button>
                  </li>
                  <li>
                    <button className="footer-link-btn" type="button" onClick={() => openSupport('faqs')}>
                      FAQs
                    </button>
                  </li>
                  <li>
